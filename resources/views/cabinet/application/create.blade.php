                ...
                <div class="col-12 col-lg-10 ">
                    ...
                    <div class="card mb-6">
                        <div class="card-header">
                            <h5 class="card-tile mb-0">Xalqaro brendlar tovarlarining ayrim turlarini brend egalari yoki ularning vakolatli yetkazib beruvchilari (rasmiy distribyutorlar, dilerlar, ishlab chiqaruvchilarning savdo vakillari va ularning distribyutorlari, litsenziatlari) bilan tuzilgan to‘g‘ridan-to‘g‘ri shartnoma asosida import qiluvchilar reyestriga kirish uchun arizaga ilova qilinadigan ma'lumot va hujjatlar ro‘yxati</h5>
                        </div>
                        <div class="card-body">
                            <div class="mb-6">
                                ...
                                <input type="text" class="form-control" id="ecommerce-product-name"
                                       placeholder="Name" name="name" aria-label="Name" value="{{old('name')}}">
                            ...
                            <div class="mb-6">
                                ...
                                @endif
                                <input type="text" class="form-control" id="ecommerce-product-name"
                                       placeholder="address" name="address" aria-label="Name" value="{{old('address')}}">
                            </div>
                            <div class="mb-6">
                                ...
                                @endif
                                <input type="text" class="form-control" id="ecommerce-product-name"
                                       placeholder="tin" name="tin" aria-label="Name" value="{{old('tin')}}">
                            </div>
                            <div class="mb-6">
                                ...
                                @endif
                                <input type="text" class="form-control" id="ecommerce-product-name"
                                       placeholder="phone" name="phone" aria-label="Name" value="{{old('phone')}}">
                            </div>
                            <div class="mb-6">
                                ...
                                @endif
                                <input type="text" class="form-control" id="ecommerce-product-name"
                                       placeholder="bank_requisite" name="bank_requisite" aria-label="Name" value="{{old('bank_requisite')}}">
                            </div>
                            <div class="mb-6">
                                ...
                                @endif
                                <input type="text" class="form-control" id="ecommerce-product-name"
                                       placeholder="brand_name" name="brand_name" aria-label="Name" value="{{old('brand_name')}}">
                            </div>
                            <div>
                                ...
                                @endif
                                <textarea class="form-control" aria-label="With textarea" placeholder="mxik" name="mxik">{{old('mxik')}}</textarea>
                            </div>
                        </div>
                    </div>
                    <!-- /Product Information -->
                    ...
                    <div class="card mb-6">
                        ...
                        <div class="card-body">
                            ...
                            <input class="form-control" type="file" id="formFile" name="official_documents" value="{{old('official_documents')}}">
                        </div>
                    </div>
                    <div class="card mb-6">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h5 class="mb-0 card-title">9. To‘g‘ridan-to‘g‘ri tuzilgan import shartnomalarining raqami va sanasi</h5>
                        </div>
                        <div class="card-body">
                        ...
                        @endif
                        <input type="text" class="form-control" id="ecommerce-product-name"
                               placeholder="contract_details" name="contract_details" aria-label="Name" value="{{old('contract_details')}}">
                        </div>
                    </div>
                    <div class="card mb-6">
                        <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <label for="formFile" class="form-label">20mb dan ko'p bo'lmagan fayl biriktiring</label>
                            <input class="form-control" type="file" id="formFile" name="at_least_country_documents" value="{{old('at_least_country_documents')}}">
                        </div>
                    </div>
                    <div class="card mb-6">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h5 class="mb-0 card-title">11. Tovarning kelib chiqishi mamlakati va ishlab chiqaruvchisi haqida dastlabki ma'lumot (yuk bojxona hududiga kelib tushganda kelib chiqish sertifikati, eksport deklaratsiyasi va tranzit deklaratsiyasi (mavjud bo‘lsa) bilan tasdiqlanadi)</h5>
                        </div>
                        <div class="card-body">
                        ...
                        @endif
                        <textarea class="form-control" aria-label="With textarea" placeholder="manufactured_countries" name="manufactured_countries">{{old('manufactured_countries')}}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="card mb-6">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <label for="formFile" class="form-label">20mb dan ko'p bo'lmagan fayl biriktiring</label>
                            <input class="form-control" type="file" id="formFile" name="retail_documents" value="{{old('retail_documents')}}">
                        </div>
                    </div>
                    <div class="card mb-6">
                        <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <label for="formFile" class="form-label">20mb dan ko'p bo'lmagan fayl biriktiring</label>
                            <input class="form-control" type="file" id="formFile" name="rent_building_documents" value="{{old('rent_building_documents')}}">
                        </div>
                    </div>
                    <div class="card mb-6">
                        <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <label for="formFile" class="form-label">20mb dan ko'p bo'lmagan fayl biriktiring</label>
                            <input class="form-control" type="file" id="formFile" name="distributor_documents" value="{{old('distributor_documents')}}">
                        </div>
                    </div>
                    <div class="card mb-6">
                        <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <label for="formFile" class="form-label">20mb dan ko'p bo'lmagan fayl biriktiring</label>
                            <input class="form-control" type="file" id="formFile" name="website_documents" value="{{old('website_documents')}}">
                        </div>
                    </div>
                    <!-- /Media -->
